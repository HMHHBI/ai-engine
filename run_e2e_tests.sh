...
cmd.exe /c "npx playwright test e2e/m3_smoke.spec.ts e2e/m3_auth_journeys.spec.ts e2e/m3_chat_journeys.spec.ts e2e/m3_document_rag.spec.ts e2e/m4_workspace_journeys.spec.ts e2e/m5_pdf_viewer_journeys.spec.ts --project=desktop --project=laptop"
