...
npx playwright test e2e/m3_smoke.spec.ts e2e/m3_auth_journeys.spec.ts e2e/m3_chat_journeys.spec.ts e2e/m3_document_rag.spec.ts --project=desktop --project=laptop
