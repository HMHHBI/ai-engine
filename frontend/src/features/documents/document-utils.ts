...
export function normalizeDocumentStatus(
  ...
  if (
    ...
    VALID_STATUSES.has(status as DocumentStatus)
  ) {
...
export function normalizeDocument(
  ...
  return {
    ...
    mime_type: String(
      raw.mime_type ?? "application/octet-stream",
    ),
    file_size:
      raw.file_size !== null &&
...
export function getDocumentLifecycleLabel(
